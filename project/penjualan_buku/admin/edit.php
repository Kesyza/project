            ...
            <form action="../admin/proses.php" method="post">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="form-group">
                        <label for="exampleInputEmail1">USER ADMIN</label> 
                        <input type="text" class="form-control" name="user_admin" value="<?php echo $user_admin; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">PASSWORD ADMIN</label>
                        <input type="text" class="form-control" name="pass_admin" value="<?php echo $pass_admin; ?>">
                    </div>
